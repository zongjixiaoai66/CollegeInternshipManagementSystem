    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="实习日志" prop="shixirizhi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="实习日志"
                  v-model="ruleForm.shixirizhi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shixirizhi" label="实习日志" prop="shixirizhi">
                    <span>{{ruleForm.shixirizhi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="实习报告" prop="shixibaogao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="实习报告"
                  v-model="ruleForm.shixibaogao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shixibaogao" label="实习报告" prop="shixibaogao">
                    <span>{{ruleForm.shixibaogao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.danweimingcheng = true;
          ...
          if(o=='shixirizhi'){
            this.ruleForm.shixirizhi = obj[o];
	    this.ro.shixirizhi = true;
            continue;
          }
          if(o=='shixibaogao'){
