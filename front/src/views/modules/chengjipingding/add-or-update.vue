<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实习成绩" prop="shixichengji">
          <el-input v-model="ruleForm.shixichengji" 
              placeholder="实习成绩" clearable  :readonly="ro.shixichengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实习成绩" prop="shixichengji">
              <el-input v-model="ruleForm.shixichengji" 
                placeholder="实习成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="日常生活" prop="richangshenghuo">
          <el-input v-model="ruleForm.richangshenghuo" 
              placeholder="日常生活" clearable  :readonly="ro.richangshenghuo"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="日常生活" prop="richangshenghuo">
              <el-input v-model="ruleForm.richangshenghuo" 
                placeholder="日常生活" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="实习过程跟踪" prop="shixiguochenggenzong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="实习过程跟踪"
                  v-model="ruleForm.shixiguochenggenzong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shixiguochenggenzong" label="实习过程跟踪" prop="shixiguochenggenzong">
                    <span>{{ruleForm.shixiguochenggenzong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	shixichengji : false,
	richangshenghuo : false,
	shixiguochenggenzong : false,
	tianjiariqi : false,
	...
	shhf : false,
      ...
      rules: {
          ...
          shixichengji: [
                { required: true, message: '实习成绩不能为空', trigger: 'blur' },
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaoshigonghao = true;
          ...
          if(o=='shixichengji'){
            this.ruleForm.shixichengji = obj[o];
	    this.ro.shixichengji = true;
            continue;
          }
          if(o=='richangshenghuo'){
            this.ruleForm.richangshenghuo = obj[o];
	    this.ro.richangshenghuo = true;
            continue;
          }
          if(o=='shixiguochenggenzong'){
            this.ruleForm.shixiguochenggenzong = obj[o];
	    this.ro.shixiguochenggenzong = true;
            continue;
          }
          if(o=='tianjiariqi'){
