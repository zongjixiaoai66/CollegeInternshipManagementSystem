<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="实习申请" prop="shixishenqing">
          <el-select :disabled="ro.shixishenqing" v-model="ruleForm.shixishenqing" placeholder="请选择实习申请">
            <el-option
                v-for="(item,index) in shixishenqingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="实习申请" prop="shixishenqing">
	      <el-input v-model="ruleForm.shixishenqing"
                placeholder="实习申请" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
	...
	shhf : false,
      ...
      ruleForm: {
        ...
        shhf: '',
          ...
          shixishenqingOptions: [],
      rules: {
          shenqingbiaoti: [
                { required: true, message: '申请标题不能为空', trigger: 'blur' },
          ],
          shixishenqing: [
                { required: true, message: '实习申请不能为空', trigger: 'blur' },
          ],
          tijiaoneirong: [
          ],
          tijiaoriqi: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shenqingbiaoti = true;
          ...
          if(o=='shixishenqing'){
            this.ruleForm.shixishenqing = obj[o];
	    this.ro.shixishenqing = true;
            continue;
          }
          if(o=='tijiaoneirong'){
      ...
      this.$http({
		...
		if(this.$storage.get("role")!="管理员") {
          ...
          this.$message.error(data.msg);
            ...
            this.shixishenqingOptions = "申请,不申请".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
