<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.danweitupian" label="单位图片" prop="danweitupian">
          <file-upload
          tip="点击上传单位图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.danweitupian" label="单位图片" prop="danweitupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.danweitupian.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.danweixingzhiOptions = "私企,国有,合资,其它".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
