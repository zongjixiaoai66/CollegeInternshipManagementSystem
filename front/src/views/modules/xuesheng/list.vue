<template>
  <div class="main-content">
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('xuesheng','实习安排') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="shixianpaiCrossAddOrUpdateHandler(scope.row,'cross','','[1]','请勿重复安排！')">{{ contents.tableBtnFont == 1?'实习安排':'' }}</el-button>
                <el-button v-if="isAuth('xuesheng','实习安排') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="shixianpaiCrossAddOrUpdateHandler(scope.row,'cross','','[1]','请勿重复安排！')">{{ contents.tableBtnFont == 1?'实习安排':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('xuesheng','实习安排') && contents.tableBtnIcon == 0" type="success" size="mini" @click="shixianpaiCrossAddOrUpdateHandler(scope.row,'cross','','[1]','请勿重复安排！')">{{ contents.tableBtnFont == 1?'实习安排':'' }}</el-button>
                <el-button v-if="isAuth('xuesheng','添加综合成绩') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="shixizonghechengjiCrossAddOrUpdateHandler(scope.row,'cross','','[1]','请勿重复添加！')">{{ contents.tableBtnFont == 1?'添加综合成绩':'' }}</el-button>
                <el-button v-if="isAuth('xuesheng','添加综合成绩') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="shixizonghechengjiCrossAddOrUpdateHandler(scope.row,'cross','','[1]','请勿重复添加！')">{{ contents.tableBtnFont == 1?'添加综合成绩':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('xuesheng','添加综合成绩') && contents.tableBtnIcon == 0" type="success" size="mini" @click="shixizonghechengjiCrossAddOrUpdateHandler(scope.row,'cross','','[1]','请勿重复添加！')">{{ contents.tableBtnFont == 1?'添加综合成绩':'' }}</el-button>
    ...
    <shixianpai-cross-add-or-update v-if="shixianpaiCrossAddOrUpdateFlag" :parent="this" ref="shixianpaiCrossaddOrUpdate"></shixianpai-cross-add-or-update>
    <shixizonghechengji-cross-add-or-update v-if="shixizonghechengjiCrossAddOrUpdateFlag" :parent="this" ref="shixizonghechengjiCrossaddOrUpdate"></shixizonghechengji-cross-add-or-update>
...
import shixianpaiCrossAddOrUpdate from "../shixianpai/add-or-update";
import shixizonghechengjiCrossAddOrUpdate from "../shixizonghechengji/add-or-update";
export default {
  data() {
    return {
      searchForm: {
      ...
      shixianpaiCrossAddOrUpdateFlag: false,
      shixizonghechengjiCrossAddOrUpdateFlag: false,
  ...
  components: {
    AddOrUpdate,
    shixianpaiCrossAddOrUpdate,
    shixizonghechengjiCrossAddOrUpdate,
  },
  methods: {
    ...
    shixianpaiCrossAddOrUpdateHandler(row,type,crossOptAudit,statusColumnName,tips,statusColumnValue){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.shixianpaiCrossAddOrUpdateFlag = true;
		...
		for (var o in obj){
		  if(o==statusColumnName && obj[o]==statusColumnValue){
			...
			this.getDataList();
		      ...
		      this.showFlag = true;
		      this.shixianpaiCrossAddOrUpdateFlag = false;
			return;
		  }
		}
	}
      this.$nextTick(() => {
      this.$refs.shixianpaiCrossaddOrUpdate.init(row.id,type);
      });
    },
    shixizonghechengjiCrossAddOrUpdateHandler(row,type,crossOptAudit,statusColumnName,tips,statusColumnValue){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.shixizonghechengjiCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','xuesheng');
      this.$storage.set('statusColumnName',statusColumnName);
      this.$storage.set('statusColumnValue',statusColumnValue);
		...
		for (var o in obj){
		  if(o==statusColumnName && obj[o]==statusColumnValue){
			...
			this.getDataList();
		      ...
		      this.showFlag = true;
		      this.shixizonghechengjiCrossAddOrUpdateFlag = false;
			return;
		  }
		}
	}
      this.$nextTick(() => {
      this.$refs.shixizonghechengjiCrossaddOrUpdate.init(row.id,type);
      });
    },
    init () {
    },
