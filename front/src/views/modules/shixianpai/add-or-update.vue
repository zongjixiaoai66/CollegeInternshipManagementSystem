<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="实习岗位" prop="shixigangwei">
          <el-select :disabled="ro.shixigangwei" @change="shixigangweiChange" v-model="ruleForm.shixigangwei" placeholder="请选择实习岗位">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.shixigangwei" label="实习岗位" prop="shixigangwei">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实习内容" prop="shixineirong">
          <el-input v-model="ruleForm.shixineirong" 
              placeholder="实习内容" clearable  :readonly="ro.shixineirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实习内容" prop="shixineirong">
              <el-input v-model="ruleForm.shixineirong" 
                placeholder="实习内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实习地点" prop="shixididian">
          <el-input v-model="ruleForm.shixididian" 
              placeholder="实习地点" clearable  :readonly="ro.shixididian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实习地点" prop="shixididian">
              <el-input v-model="ruleForm.shixididian" 
                placeholder="实习地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="日程安排" prop="richenganpai">
          <el-input v-model="ruleForm.richenganpai" 
              placeholder="日程安排" clearable  :readonly="ro.richenganpai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="日程安排" prop="richenganpai">
              <el-input v-model="ruleForm.richenganpai" 
                placeholder="日程安排" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="院系账号" prop="yuanxizhanghao">
          <el-input v-model="ruleForm.yuanxizhanghao" 
              placeholder="院系账号" clearable  :readonly="ro.yuanxizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="院系账号" prop="yuanxizhanghao">
              <el-input v-model="ruleForm.yuanxizhanghao" 
                placeholder="院系账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="实习合同" prop="shixihetong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="实习合同"
                  v-model="ruleForm.shixihetong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shixihetong" label="实习合同" prop="shixihetong">
                    <span>{{ruleForm.shixihetong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gangweixingzhi = true;
          ...
          if(o=='shixididian'){
            this.ruleForm.shixididian = obj[o];
	    this.ro.shixididian = true;
            continue;
          }
      ...
      this.$http({
		...
		if(json.yuanxizhanghao!=''&&json.yuanxizhanghao){
    ...
    shixigangweiChange () {
      this.$http({
        url: `follow/shixineirong/shixigangwei?columnValue=`+ this.ruleForm.shixigangwei,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
              if(data.data.shixineirong){
                this.ruleForm.shixineirong = data.data.shixineirong
              }
              if(data.data.gangweixingzhi){
                this.ruleForm.gangweixingzhi = data.data.gangweixingzhi
              }
              if(data.data.shixididian){
                this.ruleForm.shixididian = data.data.shixididian
              }
              if(data.data.danweimingcheng){
                this.ruleForm.danweimingcheng = data.data.danweimingcheng
              }
              if(data.data.lianxiren){
                this.ruleForm.lianxiren = data.data.lianxiren
              }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shixianpai/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shixianpaiCrossAddOrUpdateFlag = false;
						 this.parent.search();
