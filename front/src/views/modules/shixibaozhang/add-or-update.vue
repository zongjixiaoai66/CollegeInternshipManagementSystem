<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="保障名称" prop="baozhangmingcheng">
          <el-input v-model="ruleForm.baozhangmingcheng" 
              placeholder="保障名称" clearable  :readonly="ro.baozhangmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="保障名称" prop="baozhangmingcheng">
              <el-input v-model="ruleForm.baozhangmingcheng" 
                placeholder="保障名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="实习经费" prop="shixijingfei">
          <el-input v-model="ruleForm.shixijingfei" 
              placeholder="实习经费" clearable  :readonly="ro.shixijingfei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="实习经费" prop="shixijingfei">
              <el-input v-model="ruleForm.shixijingfei" 
                placeholder="实习经费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出行信息" prop="chuxingxinxi">
          <el-input v-model="ruleForm.chuxingxinxi" 
              placeholder="出行信息" clearable  :readonly="ro.chuxingxinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出行信息" prop="chuxingxinxi">
              <el-input v-model="ruleForm.chuxingxinxi" 
                placeholder="出行信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="住宿信息" prop="zhusuxinxi">
          <el-input v-model="ruleForm.zhusuxinxi" 
              placeholder="住宿信息" clearable  :readonly="ro.zhusuxinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="住宿信息" prop="zhusuxinxi">
              <el-input v-model="ruleForm.zhusuxinxi" 
                placeholder="住宿信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='baozhangmingcheng'){
            this.ruleForm.baozhangmingcheng = obj[o];
	    this.ro.baozhangmingcheng = true;
            continue;
          }
          if(o=='shixijingfei'){
            this.ruleForm.shixijingfei = obj[o];
	    this.ro.shixijingfei = true;
            continue;
          }
          if(o=='chuxingxinxi'){
            this.ruleForm.chuxingxinxi = obj[o];
	    this.ro.chuxingxinxi = true;
            continue;
          }
          if(o=='zhusuxinxi'){
            this.ruleForm.zhusuxinxi = obj[o];
	    this.ro.zhusuxinxi = true;
            continue;
          }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shixibaozhang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shixibaozhangCrossAddOrUpdateFlag = false;
						 this.parent.search();
