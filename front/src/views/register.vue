<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">高校专业实习管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			<!-- <div v-if="tableName=='yuanxifuzeren'" class="input-group">
			   <div class="label">院系账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.yuanxizhanghao" class="input" type="text" placeholder="院系账号">
			   </div>
			 </div> -->
			<el-form-item label="院系账号" class="input" v-if="tableName=='yuanxifuzeren'">
			  <el-input v-model="ruleForm.yuanxizhanghao" autocomplete="off" placeholder="院系账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yuanxifuzeren'" class="input-group">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='yuanxifuzeren'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='yuanxifuzeren'">
			...
			<el-form-item label="负责人" class="input" v-if="tableName=='yuanxifuzeren'">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='yuanxifuzeren'">
			...
			<el-form-item label="联系人" class="input" v-if="tableName=='shixidanwei'">
			...
			<el-form-item label="经营范围" class="input" v-if="tableName=='shixidanwei'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      if((!this.ruleForm.yuanxizhanghao) && `yuanxifuzeren` == this.tableName){
        this.$message.error(`院系账号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `yuanxifuzeren` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `yuanxifuzeren` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if(`yuanxifuzeren` == this.tableName && this.ruleForm.lianxidianhua&&(!this.$validate.isMobile(this.ruleForm.lianxidianhua))){
      ...
      if((!this.ruleForm.yuanxizhanghao) && `jiaoshi` == this.tableName){
        this.$message.error(`院系账号不能为空`);
        return
      }
      ...
      if((!this.ruleForm.jiaoshigonghao) && `xuesheng` == this.tableName){
        this.$message.error(`教师工号不能为空`);
        return
      }
      this.$http({
